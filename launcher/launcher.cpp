...
#include "avi/iavi.h"
//#include "avi/ibik.h" TODO: add bink video support
...
public:
	...
	virtual void Init(char const* pchBaseDir, char const* pchGameDir) { Msg("ReslistGeneratorStub: Init called.\n"); }
	virtual void Shutdown() { Msg("ReslistGeneratorStub: Shutdown called.\n"); }
	virtual bool IsActive() { Msg("ReslistGeneratorStub: IsActive called. Returned true.\n"); return true; }

	virtual void SetupCommandLine() { Msg("ReslistGeneratorStub: SetupCommandLine called.\n"); }

	virtual bool ShouldContinue() { Msg("ReslistGeneratorStub: ShouldContinue called. Returned true.\n"); return true; }
};

IResListGenerator* reslistgenerator;
...
void TryToLoadSteamOverlayDLL()
{
	...
	if ( bSteamActive )
	{
		// steam overlay isnt suppoted in css v34 :)
...
bool CSourceAppSystemGroup::Create()
{
	...
	{
		 //{ "engine.dll",				CVAR_QUERY_INTERFACE_VERSION },	// Not implemented
#if defined( _X360 )
		...
		{ "vphysics.dll",			VPHYSICS_INTERFACE_VERSION },
 		...
 		// { "valve_avi.dll",			BIK_INTERFACE_VERSION }, TODO: add bink video support
#endif
	...
	Msg("LoadAppSystems:  Took %.4f secs to load libraries and get factories.\n", (float)elapsed);
